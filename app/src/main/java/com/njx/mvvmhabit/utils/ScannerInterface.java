...
public class ScannerInterface {
	...
	private static ScannerInterface scannerInterface;

	public static ScannerInterface getInstance(){
		if (scannerInterface == null) {
			scannerInterface=new ScannerInterface();
		}
		return scannerInterface;
	}

	private ScannerInterface() {
